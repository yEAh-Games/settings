document.getElementById('file-input').addEventListener('change', function(event) {
    ...
    fetch('https://api.github.com/repos/yeah-games/ugc-uploads/contents/profile/p/default/png/' + encodeURIComponent("@" + username + ".png"), {
      method: 'DELETE',
      headers: {
    ...
    .then(function(response) {
      if (response.ok) {
        ...
        return fetch('https://api.github.com/repos/yeah-games/ugc-uploads/contents/profile/p/default/png/' + encodeURIComponent("@" + username + ".png"), {
          method: 'PUT',
          headers: {
            'Authorization': 'Bearer ' + authorizeFromAPIServer,
