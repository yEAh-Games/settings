document.addEventListener("DOMContentLoaded", function () {
    ...
    if (userData && userData.username) {
        ...
        fetch("https://accounts.ynwk.org/data/settings/profiles.json")
            ...
            .then(function (profileData) {
                ...
                if (userProfile) {
                    fetch("https://accounts.ynwk.org/data/accounts.json")
                        .then(function (response) {
                            if (response.ok) {
                                return response.json();
                            } else {
                        ...
                        .then(function (accountData) {
                            ...
                            var profilePictureSrc = "https://ugc.ynwk.org/profile/p/default/png/" + "@" + userData.username + ".png";
